...
Ce qui lui résiste encore : implémenter des choses que l'on n'a jamais faites dans le projet, des refactorings complexes.
...
Avec de nombreuses démonstrations, ce retour d'expérience brut présente des succès, des échecs et des leçons concrètes pour intégrer l’IA dans vos projets sans perdre le contrôle.
...
Depuis 3 ans, avec une équipe de 6 développeurs, nous avons construit et maintenons une data plateforme qui traite plusieurs To de données chaque mois, plus de 1 million d'événements par jour, et supporte une centaine de cas d’usage… pour moins de 5 000 €/mois de coûts cloud.
...
Plutôt que d'ajouter des ressources de calcul et des technologies, réfléchissez à l'architecture, au code et au stockage des données pour économiser les ressources matérielles.

🚀 Les premières optimisations relèvent des bonnes pratiques que tout le monde devrait savoir appliquer ; les suivantes sont sacrificielles : elles dégradent la lisibilité et la maintenabilité du code. Pensé comme une déclinaison concrète de la loi d'Eroom proposée par Tristan Nitot, ce talk commencera avec un exemple de code bien mal codé comme nous l'avons tous déjà fait, puis, au fil des optimisations, nous verrons les bénéfices et les sacrifices à faire pour aller toujours plus vite.
...
- Touraine Tech, février 2025, Tours
...
Un talk itératif durant lequel Sofia et Emmanuel-Lin dessinent une architecture de Data Science au fil des évolutions des
besoins métiers.
...
Une fois en production, il faut monitorer son système modèle. À part un drift de données dans tous les sens, comment choisir les bonnes métriques à suivre dans un système qui contient beaucoup d'incertitudes ?
...
- La matinale Ethical by Design d'OCTO, novembre 2019, Paris : [vidéo](https://youtu.be/o_TBFPvUQ30?si=kDOehwTVNQ93HRAa&t=5753), [compte rendu dans la presse](https://www.alliancy.fr/solution-ia-confiance-etait-ethical-by-design) écrit par Christophe Auffray
...
Présentation de la librairie R open source que j'ai développée et maintiens depuis de nombreuses années pour faire de la préparation de données efficiente.

📍 Talk donné à :
- [Data Science Conference Europe](https://datasciconference.com), novembre 2021 (remote)
- Meetup [R addicts Paris](https://www.meetup.com/fr-FR/rparis/), août 2018 (Paris) : [slides](https://fr.slideshare.net/EmmanuelLinTOULEMOND/presentation-of-datapreparation-at-mett-up-raddicts)
