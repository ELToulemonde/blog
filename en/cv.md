...
- [MLOps 1 Industrialisation](https://www.octo.academy/catalogue/formation/dsind-mlops-industrialisation-dun-projet-de-data-science/):
  Moving from a notebook to a tested and documented Python package,
- [MLOps 2 Production deployment](https://www.octo.academy/catalogue/formation/dsin2-mlops-industrialisation-avancee-dun-projet-de-data-science/):
  Moving from a Python package to a production application that makes predictions every minute, is monitored, and has a continuous improvement cycle,
- [MLOps 3 Run](https://www.octo.academy/catalogue/formation/dsin3-mlops-run-et-evolutivite-de-modeles-de-machine-learning/):
  Maintaining and evolving an ML application,
